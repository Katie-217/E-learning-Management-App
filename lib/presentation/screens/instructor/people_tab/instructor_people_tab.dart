...
import 'package:elearning_management_app/presentation/screens/instructor/csv_import/csv_import_group.dart';
  ...
  Future<void> _loadInstructorName() async {
    try {
      ...
      if (userDoc.exists && mounted) {
        ...
        setState(() {
          _instructorName = data?['name'] ?? widget.course.instructor;
        });
      } else if (mounted) {
        setState(() {
          _instructorName = widget.course.instructor;
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Icon(Icons.school,
                            color: Colors.indigo[400], size: teacherIconSize),
                      ],
                    ),
              ...
              Expanded(
                child: DropdownMenu<String>(
                  ...
                  leadingIcon: Icon(Icons.group,
                      color: Colors.indigo[400], size: iconSize),
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.person_add,
                                color: Colors.indigo, size: iconSize),
                            SizedBox(width: spacing),
        ...
        return Row(
          children: [
            ...
            Expanded(
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle:
                      TextStyle(color: Colors.grey[400], fontSize: hintSize),
                  prefixIcon:
            ...
            ExportStudentCSV(
              ...
              getStudents: _getFilteredStudents,
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.error_outline,
                        size: iconSize, color: Colors.red[400]),
