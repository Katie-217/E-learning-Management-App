  ...
  Future<String?> _getStudentGroupId(String courseId, String userId) async {
    try {
      ...
      if (groupId == null || groupId.isEmpty) {
        print(
            'DEBUG: ⚠️ No groupId found for user $userId in course $courseId');
      } else {
        print('DEBUG: ✅ Found groupId $groupId for user $userId');
      }
      return groupId;
    } catch (e, stackTrace) {
      print('DEBUG: ❌ Error fetching groupId for student: $e');
      print('DEBUG: Stack trace: $stackTrace');
      return null;
    }
  }
